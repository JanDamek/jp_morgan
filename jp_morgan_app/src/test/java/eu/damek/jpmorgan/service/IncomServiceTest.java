...
public class IncomServiceTest {
    ...
    public void addAmount() throws Exception {
        incomService.addAmount(new Date(2016, 1, 5), 1000);
        incomService.addAmount(new Date(2016, 1, 5), 1000);
        incomService.addAmount(new Date(2016, 1, 5), 1000);
        incomService.addAmount(new Date(2016, 1, 5), 1000);
        incomService.addAmount(new Date(2016, 1, 5), 1000);
        final List<SettledIncoming> incoms = incomService.getSettledIncomings();
        assertEquals(incoms.size(), 1);
        assertEquals(incoms.get(0).getIncoming(), 5000,0.001);

        incomService.addAmount(new Date(2016, 1, 6), 1000);
        incomService.addAmount(new Date(2016, 1, 7), 1000);
        incomService.addAmount(new Date(2016, 1, 8), 1000);
        incomService.addAmount(new Date(2016, 1, 9), 1000);
        incomService.addAmount(new Date(2016, 1, 10), 1000);
        final List<SettledIncoming> incoms1 = incomService.getSettledIncomings();
